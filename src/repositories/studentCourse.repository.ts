import type { Course, StudentCourse, StudentItemType } from "@prisma/client";
...
export const studentCourseRepository = {
  findByUserAndType(userId: string, type: StudentItemType): Promise<(StudentCourse & { course: Course })[]> {
